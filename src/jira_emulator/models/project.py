...
class Project(Base):
    ...
    issue_sequences: Mapped[list["IssueSequence"]] = relationship(back_populates="project")
...
class ProjectWorkflow(Base):
    ...
    issue_type_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("issue_types.id"), nullable=True)
